...
public class Tela_Alunos extends javax.swing.JFrame {
        ...
        try {
            if (inativo.isSelected() == false) {
                for (AlunosBEAN aluno : listAlunos) {
                    if (aluno.getSituacaoAluno() == 1) {
                        modelo.addRow(new Object[]{aluno.getMatriculaAluno(), aluno.getNomeAluno(), aluno.getCpfAluno(), aluno.getSituacaoAluno(), aluno.getUltimaAtualizacao()});
                    }
                }
            } else {
                for (AlunosBEAN aluno : listAlunos) {
                    if (aluno.getSituacaoAluno() == 0) {
                        modelo.addRow(new Object[]{aluno.getMatriculaAluno(), aluno.getNomeAluno(), aluno.getCpfAluno(), aluno.getSituacaoAluno(), aluno.getUltimaAtualizacao()});
                    }
                }
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (id.getText().isEmpty()) {
            ...
            AlunosBEAN aluno = new AlunosBEAN(nome.getText(), cpf.getText(), 1, horalocal);
            ...
            if (nome.getText().isEmpty() || cpf.getText().isEmpty() || ativado.getText().isEmpty() || desativado.getText().isEmpty()) {
                ...
                if (ativado.isSelected()) {
                    AlunosBEAN aluno = new AlunosBEAN(Integer.parseInt(id.getText()), nome.getText(), cpf.getText(), 1, horalocal);
                    controle.updateAluno(aluno);
                } else {
                    AlunosBEAN aluno = new AlunosBEAN(Integer.parseInt(id.getText()), nome.getText(), cpf.getText(), 0, horalocal);
                    controle.updateAluno(aluno);
                }
                id.setText("");
                nome.setText("");
